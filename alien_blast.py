...
def run_game():
    ...
    while True:
        # 检查事件
        func.check_events(ab_settings, screen, stats, scoreboard, play_button, ship, aliens, bullets)
        ...
        if stats.game_active:
            ...
            # Alien事件
            func.update_aliens(ab_settings, stats, scoreboard, screen, ship, aliens, bullets)
